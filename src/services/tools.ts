...
class ToolsClass {
   ...
   */
  handlefilterVehicle = (vehicleList: vehicleType[], filterObj: filterType): vehicleType[] => {
   ...
   */
  handlefilterClient = (clientList: clientType[], filterObj: filterType): clientType[] => {
...
export const tools = Object.freeze(new ToolsClass());
